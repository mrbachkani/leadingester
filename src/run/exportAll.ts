...
async function main() {
  ...
  const outPath = path.join(exportDir, `india_leads_${dateStr}.csv`);

  console.log("Exporting all leads to master CSV...");
  ...
  console.log(`\nExport complete!`);
  console.log(`Total leads: ${res.rows.length}`);
  console.log(`File: ${outPath}`);

  // Also print search progress summary
